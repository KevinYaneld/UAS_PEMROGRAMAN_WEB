...
<body style="background-color: var(--secondary-color);">
    ...
    <div class ="container"id="home">
        ...
        <div class="row-1"id="home">
            <div class = "col-1">
                <h2>AWESOME APPS</h2>
                <P>Website Baru Yang Dapat Mempermudah Anda Dalam Mendapatkan Aplikasi</P>
        ...
        <div class="row-2" id="about">
            <div class = "col-1">
                ...
                <P id ="info" style="display: none">Website ini dibuat oleh seorang mahasiswa untuk mengerjakan Tugas 
